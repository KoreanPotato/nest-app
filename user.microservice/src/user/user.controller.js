...
var JwtAuthGuard_1 = require("../auth/JwtAuthGuard");
var UserController = function () {
    ...
    var UserController = _classThis = /** @class */ (function () {
        ...
        UserController_1.prototype.createUser = function (createUserDto) {
            return __awaiter(this, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    return [2 /*return*/, this.userService.createUser(createUserDto)];
                });
            });
        };
        UserController_1.prototype.updateUser = function (req, updateData) {
            return __awaiter(this, void 0, void 0, function () {
                var userId;
                return __generator(this, function (_a) {
                    userId = req.user.userId;
                    return [2 /*return*/, this.userService.updateUser(userId, updateData)];
                });
            });
        };
    ...
    (function () {
        ...
        _updateUser_decorators = [(0, common_1.UseGuards)(JwtAuthGuard_1.JwtAuthGuard), (0, common_1.Patch)('update')];
